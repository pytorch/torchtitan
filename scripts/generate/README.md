...
```bash
NGPU=1 CONFIG_FILE=./torchtitan/models/llama3/train_configs/llama3_8b.py CHECKPOINT_DIR=./outputs/checkpoint/ \
...
```bash
NGPU=4 CONFIG_FILE=./torchtitan/models/llama3/train_configs/llama3_8b.py CHECKPOINT_DIR=./outputs/checkpoint/ \
PROMPT="What is the meaning of life?" \
