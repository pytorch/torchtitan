# source: https://github.com/deepseek-ai/DeepEP/blob/92fe2deaec24bc92ebd9de276daa6ca9ed602ed4/tests/test_internode.py#L1
        ...
        for async_mode in (False, True):
            for current_x in (x_pure_rand, x, x_pure_rand_e4m3, x_e4m3):
                for with_topk in (False, True):
                    ...
                    assert (
                        calc_diff(check_x, ref_x) < 5e-4
                        if current_x is x_pure_rand_e4m3
                        else 5e-6
                    )
                    if with_topk:
                        check_topk_weights = (
                        ...
                        ref_topk_weights = (
                            topk_weights_pure_rand if is_rand else topk_weights
                        )
...
def test_loop(local_rank: int, num_local_ranks: int, args: argparse.Namespace):
    ...
    if args.test_ll_compatibility:
        ...
        benchmark_low_latency.test_main(
            ll_num_tokens,
            ll_hidden,
            ll_num_experts,
            ll_num_topk,
