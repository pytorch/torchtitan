...
# fixup from vasiliy_sweep_regional_linear:
# one of the experiments had a transient error, re-running
...
do
    ...
    do
        ...
        # v8 for fixup
        OUTPUT_SUBFOLDER="20241204_v8_regional_linear_llama3_8b_name_${NAME}_ac_${AC_SETTING}"
