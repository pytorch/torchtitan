...
1. Make sure `metrics.enable_tensorboard` option is set to true in model training (either from a Python config file or from CLI).
...
For an example you can inspect the Llama 3 [debug_model.py](../torchtitan/models/llama3/train_configs/debug_model.py)
