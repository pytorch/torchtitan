...
export EXTERNAL_EVAL_FREQ=${EXTERNAL_EVAL_FREQ:-5}
...
export EXTERNAL_EVAL_CUDA_VISIBLE_DEVICES=${EXTERNAL_EVAL_CUDA_VISIBLE_DEVICES:-"1"}
export EXTERNAL_EVAL_EXPORT_DTYPE=${EXTERNAL_EVAL_EXPORT_DTYPE:-"bfloat16"}
export EXTERNAL_EVAL_EXTRA_ARGS=${EXTERNAL_EVAL_EXTRA_ARGS:-"--lm-eval-bin 'python -m lm_eval' --lm-eval-model torchtitan_dcp --lm-eval-extra-args '--batch_size 1'"}
