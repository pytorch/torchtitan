...
Usage:
  python -m autoresearch.kernel_agent.run_all [--problems PROB1 PROB2 ...]
  python -m autoresearch.kernel_agent.run_all  # runs all
  python -m autoresearch.kernel_agent.run_all --skip-optimize  # generation only
"""
...
def generate_one(name: str) -> dict:
    ...
    from autoresearch.kernel_agent.bridge import generate_kernel
...
def optimize_one(name: str, opt_rounds: int = 5) -> dict:
    ...
    from autoresearch.kernel_agent.bridge import optimize_kernel
