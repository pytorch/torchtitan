...
class TestMoERoutingCounts(unittest.TestCase):
    ...
    Validates that expert token counting is correct and deterministic across
    repeated calls. Works in conjunction with saving topk outputs during
    activation checkpointing to ensure stable expert assignments.
    """
