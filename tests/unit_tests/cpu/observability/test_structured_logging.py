...
def structured_logger_fixture():
    ...
    tl._subprocess_init_fn = subprocess_init_fn
    sl_mod._is_initialized = False
...
class TestInitStructuredLogger:
    ...
    def test_records_subprocess_init_fn(self, tmp_path, structured_logger_fixture):
        ...
        subprocess_init_fn = structured_logger_fixture._subprocess_init_fn
