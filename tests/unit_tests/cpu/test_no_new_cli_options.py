...
_FROZEN_CLI_OPTIONS = frozenset(
    {
        ...
        "async_eval.checkpoint_interval",
        "async_eval.cuda_visible_devices",
        "async_eval.enable",
        "async_eval.exit_timeout",
        "async_eval.extra_args",
        "async_eval.forward_train_args",
        "async_eval.launcher",
        "async_eval.output_folder",
        "async_eval.preserve_checkpoints",
