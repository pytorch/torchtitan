...
class TestProfilerConfig(unittest.TestCase):
    def test_default_field_values(self):
        ...
        self.assertTrue(cfg.enable_module_record_function)
        self.assertFalse(cfg.enable_module_mark_kernels)
        self.assertEqual(cfg.module_profiler_include, [])
        self.assertEqual(cfg.module_profiler_exclude, [])
