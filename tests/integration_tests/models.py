...
def build_model_tests_list() -> list[OverrideDefinitions]:
    ...
    model_tests = [
        ...
        OverrideDefinitions(
            [
                [
                    "--model deepseek_v3 --config deepseek_v3_debugmodel_flex_attn",
                    "--parallelism.data_parallel_shard_degree 4",
                    "--parallelism.pipeline_parallel_degree 2",
                    "--parallelism.pipeline_parallel_schedule Interleaved1F1B",
                    "--parallelism.expert_parallel_degree 4",
        ...
        OverrideDefinitions(
            [
                [
                    "--model qwen3 --config qwen3_debugmodel",
                    "--parallelism.data_parallel_shard_degree 2",
                    "--parallelism.tensor_parallel_degree 2",
                ],
            ],
        ...
        OverrideDefinitions(
            [
                [
                    "--model qwen3 --config qwen3_moe_debug",
                    "--parallelism.data_parallel_shard_degree 2",
                    "--parallelism.tensor_parallel_degree 2",
                    "--parallelism.expert_parallel_degree 2",
                    "--parallelism.expert_tensor_parallel_degree 2",
        ...
        OverrideDefinitions(
            [
                [
                    "--model llama4 --config llama4_debugmodel",
                    "--parallelism.pipeline_parallel_degree 2",
                    "--parallelism.pipeline_parallel_schedule Interleaved1F1B",
                    "--parallelism.data_parallel_shard_degree 2",
                    "--parallelism.tensor_parallel_degree 2",
        ...
        OverrideDefinitions(
            [
                [
                    "--model gpt_oss --config gpt_oss_debugmodel",
                    "--parallelism.data_parallel_shard_degree 4",
                    "--parallelism.tensor_parallel_degree 2",
                    "--parallelism.expert_parallel_degree 4",
                    "--parallelism.expert_tensor_parallel_degree 1",
