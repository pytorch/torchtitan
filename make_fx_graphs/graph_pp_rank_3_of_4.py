...
def forward(self, forward_mb_index, arg_mb, kwargs_mb):
    ...
    _to_copy_1 = torch.ops.aten._to_copy.default(mul_1, dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=3));  mul_1 = None
    ...
    _to_copy_7 = torch.ops.aten._to_copy.default(mul_5, dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=3));  mul_5 = None
    ...
    _to_copy_9 = torch.ops.aten._to_copy.default(mul_7, dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=3));  mul_7 = None
    ...
    all_to_all_single_1 = torch.ops._c10d_functional.all_to_all_single.default(view_20, [26, 25], [23, 25], '8');  view_20 = None
    wait_tensor_2 = torch.ops._c10d_functional.wait_tensor.default(all_to_all_single_1);  all_to_all_single_1 = None
    view_23 = torch.ops.aten.view.default(wait_tensor_2, [51, 32]);  wait_tensor_2 = None
    ...
    full = torch.ops.aten.full.default([83], -1, dtype = torch.int32, device = device(type='cuda', index=3), pin_memory = False)
    ...
    new_empty = torch.ops.aten.new_empty.default(_grouped_mm_2, [52, 32], pin_memory = False)
    ...
    all_to_all_single_2 = torch.ops._c10d_functional.all_to_all_single.default(slice_1, [23, 25], [26, 25], '8');  slice_1 = None
    ...
    _to_copy_18 = torch.ops.aten._to_copy.default(mul_14, dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=3));  mul_14 = None
    ...
    _to_copy_24 = torch.ops.aten._to_copy.default(mul_18, dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=3));  mul_18 = None
    ...
    _to_copy_26 = torch.ops.aten._to_copy.default(mul_20, dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=3));  mul_20 = None
    ...
    all_to_all_single_4 = torch.ops._c10d_functional.all_to_all_single.default(view_51, [23, 29], [19, 29], '8');  view_51 = None
    wait_tensor_6 = torch.ops._c10d_functional.wait_tensor.default(all_to_all_single_4);  all_to_all_single_4 = None
    view_54 = torch.ops.aten.view.default(wait_tensor_6, [52, 32]);  wait_tensor_6 = None
    ...
    full_1 = torch.ops.aten.full.default([84], -1, dtype = torch.int32, device = device(type='cuda', index=3), pin_memory = False)
    ...
    new_empty_1 = torch.ops.aten.new_empty.default(_grouped_mm_5, [53, 32], pin_memory = False)
    ...
    all_to_all_single_5 = torch.ops._c10d_functional.all_to_all_single.default(slice_2, [19, 29], [23, 29], '8');  slice_2 = None
    ...
    _to_copy_35 = torch.ops.aten._to_copy.default(mul_27, dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=3));  mul_27 = None
    ...
    _to_copy_41 = torch.ops.aten._to_copy.default(mul_31, dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=3));  mul_31 = None
    ...
    _to_copy_43 = torch.ops.aten._to_copy.default(mul_33, dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=3));  mul_33 = None
    ...
    all_to_all_single_7 = torch.ops._c10d_functional.all_to_all_single.default(view_82, [25, 22], [26, 22], '8');  view_82 = None
    wait_tensor_10 = torch.ops._c10d_functional.wait_tensor.default(all_to_all_single_7);  all_to_all_single_7 = None
    view_85 = torch.ops.aten.view.default(wait_tensor_10, [47, 32]);  wait_tensor_10 = None
    ...
    full_2 = torch.ops.aten.full.default([79], -1, dtype = torch.int32, device = device(type='cuda', index=3), pin_memory = False)
    ...
    new_empty_2 = torch.ops.aten.new_empty.default(_grouped_mm_8, [48, 32], pin_memory = False)
    ...
    all_to_all_single_8 = torch.ops._c10d_functional.all_to_all_single.default(slice_3, [26, 22], [25, 22], '8');  slice_3 = None
    ...
    _to_copy_52 = torch.ops.aten._to_copy.default(mul_40, dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=3));  mul_40 = None
    ...
    _to_copy_58 = torch.ops.aten._to_copy.default(mul_44, dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=3));  mul_44 = None
    ...
    _to_copy_60 = torch.ops.aten._to_copy.default(mul_46, dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=3));  mul_46 = None
    ...
    all_to_all_single_10 = torch.ops._c10d_functional.all_to_all_single.default(view_113, [23, 24], [24, 24], '8');  view_113 = None
    wait_tensor_14 = torch.ops._c10d_functional.wait_tensor.default(all_to_all_single_10);  all_to_all_single_10 = None
    view_116 = torch.ops.aten.view.default(wait_tensor_14, [47, 32]);  wait_tensor_14 = None
    ...
    full_3 = torch.ops.aten.full.default([79], -1, dtype = torch.int32, device = device(type='cuda', index=3), pin_memory = False)
    ...
    new_empty_3 = torch.ops.aten.new_empty.default(_grouped_mm_11, [48, 32], pin_memory = False)
    ...
    all_to_all_single_11 = torch.ops._c10d_functional.all_to_all_single.default(slice_4, [24, 24], [23, 24], '8');  slice_4 = None
    ...
    _to_copy_68 = torch.ops.aten._to_copy.default(gather_8, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=3));  gather_8 = None
    ...
    _to_copy_69 = torch.ops.aten._to_copy.default(mul_58, dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=3));  mul_58 = None
    all_to_all_single_12 = torch.ops._c10d_functional.all_to_all_single.default(_to_copy_69, [23, 24], [24, 24], '8');  _to_copy_69 = None
    wait_tensor_16 = torch.ops._c10d_functional.wait_tensor.default(all_to_all_single_12);  all_to_all_single_12 = None
    slice_backward = torch.ops.aten.slice_backward.default(wait_tensor_16, [48, 32], 0, 0, -1, 1);  wait_tensor_16 = None
    ...
    new_zeros_4 = torch.ops.aten.new_zeros.default(add_19, [48, 32], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=3))
    index_put = torch.ops.aten.index_put.default(new_zeros_4, [full_3], add_19, True);  new_zeros_4 = full_3 = add_19 = None
    slice_5 = torch.ops.aten.slice.Tensor(index_put, 0, 0, 47)
    slice_6 = torch.ops.aten.slice.Tensor(index_put, 0, 47, 48);  index_put = slice_6 = None
    all_to_all_single_13 = torch.ops._c10d_functional.all_to_all_single.default(slice_5, [24, 24], [23, 24], '8');  slice_5 = None
    ...
    new_zeros_6 = torch.ops.aten.new_zeros.default(view_125, [48], dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=3))
    ...
    _to_copy_70 = torch.ops.aten._to_copy.default(_softmax_backward_data, dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=3));  _softmax_backward_data = None
    ...
    _to_copy_71 = torch.ops.aten._to_copy.default(sum_14, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=3));  sum_14 = None
    ...
    _to_copy_72 = torch.ops.aten._to_copy.default(view_135, dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=3));  view_135 = None
    ...
    _to_copy_73 = torch.ops.aten._to_copy.default(slice_10, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=3));  slice_10 = None
    ...
    _to_copy_74 = torch.ops.aten._to_copy.default(view_139, dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=3));  view_139 = None
    ...
    _to_copy_75 = torch.ops.aten._to_copy.default(gather_9, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=3));  gather_9 = None
    ...
    _to_copy_76 = torch.ops.aten._to_copy.default(mul_73, dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=3));  mul_73 = None
    all_to_all_single_14 = torch.ops._c10d_functional.all_to_all_single.default(_to_copy_76, [25, 22], [26, 22], '8');  _to_copy_76 = None
    wait_tensor_18 = torch.ops._c10d_functional.wait_tensor.default(all_to_all_single_14);  all_to_all_single_14 = None
    slice_backward_1 = torch.ops.aten.slice_backward.default(wait_tensor_18, [48, 32], 0, 0, -1, 1);  wait_tensor_18 = None
    ...
    new_zeros_8 = torch.ops.aten.new_zeros.default(add_28, [48, 32], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=3))
    index_put_2 = torch.ops.aten.index_put.default(new_zeros_8, [full_2], add_28, True);  new_zeros_8 = full_2 = add_28 = None
    slice_11 = torch.ops.aten.slice.Tensor(index_put_2, 0, 0, 47)
    slice_12 = torch.ops.aten.slice.Tensor(index_put_2, 0, 47, 48);  index_put_2 = slice_12 = None
    all_to_all_single_15 = torch.ops._c10d_functional.all_to_all_single.default(slice_11, [26, 22], [25, 22], '8');  slice_11 = None
    ...
    new_zeros_10 = torch.ops.aten.new_zeros.default(view_144, [48], dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=3))
    ...
    _to_copy_77 = torch.ops.aten._to_copy.default(_softmax_backward_data_1, dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=3));  _softmax_backward_data_1 = None
    ...
    _to_copy_78 = torch.ops.aten._to_copy.default(sum_16, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=3));  sum_16 = None
    ...
    _to_copy_79 = torch.ops.aten._to_copy.default(view_154, dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=3));  view_154 = None
    ...
    _to_copy_80 = torch.ops.aten._to_copy.default(slice_16, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=3));  slice_16 = None
    ...
    _to_copy_81 = torch.ops.aten._to_copy.default(view_158, dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=3));  view_158 = None
    ...
    _to_copy_82 = torch.ops.aten._to_copy.default(gather_10, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=3));  gather_10 = None
    ...
    _to_copy_83 = torch.ops.aten._to_copy.default(mul_88, dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=3));  mul_88 = None
    all_to_all_single_16 = torch.ops._c10d_functional.all_to_all_single.default(_to_copy_83, [23, 29], [19, 29], '8');  _to_copy_83 = None
    wait_tensor_20 = torch.ops._c10d_functional.wait_tensor.default(all_to_all_single_16);  all_to_all_single_16 = None
    slice_backward_2 = torch.ops.aten.slice_backward.default(wait_tensor_20, [53, 32], 0, 0, -1, 1);  wait_tensor_20 = None
    ...
    new_zeros_12 = torch.ops.aten.new_zeros.default(add_37, [53, 32], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=3))
    index_put_4 = torch.ops.aten.index_put.default(new_zeros_12, [full_1], add_37, True);  new_zeros_12 = full_1 = add_37 = None
    slice_17 = torch.ops.aten.slice.Tensor(index_put_4, 0, 0, 52)
    slice_18 = torch.ops.aten.slice.Tensor(index_put_4, 0, 52, 53);  index_put_4 = slice_18 = None
    all_to_all_single_17 = torch.ops._c10d_functional.all_to_all_single.default(slice_17, [19, 29], [23, 29], '8');  slice_17 = None
    ...
    new_zeros_14 = torch.ops.aten.new_zeros.default(view_163, [48], dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=3))
    ...
    _to_copy_84 = torch.ops.aten._to_copy.default(_softmax_backward_data_2, dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=3));  _softmax_backward_data_2 = None
    ...
    _to_copy_85 = torch.ops.aten._to_copy.default(sum_18, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=3));  sum_18 = None
    ...
    _to_copy_86 = torch.ops.aten._to_copy.default(view_173, dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=3));  view_173 = None
    ...
    _to_copy_87 = torch.ops.aten._to_copy.default(slice_22, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=3));  slice_22 = None
    ...
    _to_copy_88 = torch.ops.aten._to_copy.default(view_177, dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=3));  view_177 = None
    ...
    _to_copy_89 = torch.ops.aten._to_copy.default(gather_11, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=3));  gather_11 = None
    ...
    _to_copy_90 = torch.ops.aten._to_copy.default(mul_103, dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=3));  mul_103 = None
    all_to_all_single_18 = torch.ops._c10d_functional.all_to_all_single.default(_to_copy_90, [26, 25], [23, 25], '8');  _to_copy_90 = None
    wait_tensor_22 = torch.ops._c10d_functional.wait_tensor.default(all_to_all_single_18);  all_to_all_single_18 = None
    slice_backward_3 = torch.ops.aten.slice_backward.default(wait_tensor_22, [52, 32], 0, 0, -1, 1);  wait_tensor_22 = None
    ...
    new_zeros_16 = torch.ops.aten.new_zeros.default(add_46, [52, 32], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=3))
    index_put_6 = torch.ops.aten.index_put.default(new_zeros_16, [full], add_46, True);  new_zeros_16 = full = add_46 = None
    slice_23 = torch.ops.aten.slice.Tensor(index_put_6, 0, 0, 51)
    slice_24 = torch.ops.aten.slice.Tensor(index_put_6, 0, 51, 52);  index_put_6 = slice_24 = None
    all_to_all_single_19 = torch.ops._c10d_functional.all_to_all_single.default(slice_23, [23, 25], [26, 25], '8');  slice_23 = None
    ...
    new_zeros_18 = torch.ops.aten.new_zeros.default(view_182, [48], dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=3))
    ...
    _to_copy_91 = torch.ops.aten._to_copy.default(_softmax_backward_data_3, dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=3));  _softmax_backward_data_3 = None
    ...
    _to_copy_92 = torch.ops.aten._to_copy.default(sum_20, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=3));  sum_20 = None
    ...
    _to_copy_93 = torch.ops.aten._to_copy.default(view_192, dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=3));  view_192 = None
    ...
    _to_copy_94 = torch.ops.aten._to_copy.default(slice_28, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=3));  slice_28 = None
    ...
    _to_copy_95 = torch.ops.aten._to_copy.default(view_196, dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=3));  view_196 = None
