...
def get_peak_flops(device_name: str) -> float:
    ...
    if "A100" in device_name:
        ...
        neuron_device_name = torch.neuron.get_device_properties().name
        if neuron_device_name in ("trn1", "trn1n", "inf2"):
            # NeuronCore-v2 TensorEngine: 90 BF16 TFLOPS/core, LNC=1
            # data from https://awsdocs-neuron.readthedocs-hosted.com/en/latest/about-neuron/arch/neuron-hardware/neuron-core-v2.html
            return 90e12 * 1
        elif neuron_device_name in ("trn2", "trn2n", "trn2u"):
            # NeuronCore-v3 TensorEngine: 79 BF16 TFLOPS/core, LNC=2
            # data from https://awsdocs-neuron.readthedocs-hosted.com/en/latest/about-neuron/arch/neuron-hardware/neuron-core-v3.html
            return 79e12 * 2
        elif neuron_device_name in ("trn3", "trn3u"):
            # NeuronCore-v4 TensorEngine: 79 BF16 TFLOPS/core, LNC=2
            # data from https://awsdocs-neuron.readthedocs-hosted.com/en/latest/about-neuron/arch/neuron-hardware/neuron-core-v4.html
            return 79e12 * 2
