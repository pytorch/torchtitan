...
class MoE(nn.Module):
    def __init__(self, model_args: TransformerModelArgs):
        ...
        self.fused = model_args.use_fused_moe_impl
        self.experts = GroupedExperts(
            dim=dim, hidden_dim=hidden_dim, num_experts=num_experts, fused=self.fused
        )
        ...
        self.shared_expert = (
            GroupedExperts(
                dim=dim, hidden_dim=hidden_dim, num_experts=1, fused=self.fused
            )
