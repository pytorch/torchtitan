...
from .expert_parallel import ExpertParallel, NoParallel, TensorParallel
...
def parallelize_llama(
    ...
    if parallel_dims.tp_enabled or parallel_dims.ep_enabled:
        apply_ep(
            model,
            world_mesh["tp"] if parallel_dims.tp_enabled else None,
            world_mesh["ep"] if parallel_dims.ep_enabled else None,
        )
...
def apply_ep(
    ...
    # TODO: implement EP + TP
    if tp_mesh is not None and ep_mesh is not None:
        raise NotImplementedError("EP + TP support is WIP")
