    ...
    def step(self, closure=None):
        ...
        for group_idx, group in enumerate(self.param_groups):
            ...
            for p_name, p in zip(group["param_names"], group["params"]):
                ...
                if param_type == ParamType.DDP:
                    ...
                    bias_param_names.append(p_name)
        ...
        if self.log_parameters_types:
            ...
            logger.info(
                ...
                f"scale_params: {len(scale_params)} | bias_params: {len(bias_params)}"
            )
        ...
        self.step_bias(bias_params, bias_param_names)
