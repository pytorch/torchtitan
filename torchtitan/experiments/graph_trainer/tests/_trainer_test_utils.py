...
from torchtitan.trainer import ForwardBackwardStepBuilder, Trainer
...
def build_minimal_trainer(
    ...
    *,
    ...
    trainer.forward_backward_step_fn = builder.with_step_wrapper(
        trainer._graph_forward_backward_step
    ).build()
