...
def _run_deepseek_v3_ep_overlap_loss_compare() -> bool:
    ...
    return _run_deepseek_v3_loss_compare(
        ...
        test_options_extra=DSV3_EP_OVERLAP_OPTIONS + DSV3_EP_OVERLAP_GRAPH,
    )
...
def _run_deepseek_v3_ep_overlap_moe_seq_loss_compare() -> bool:
    ...
    return _run_deepseek_v3_loss_compare(
        baseline_config="graph_trainer_deepseek_v3_debugmodel_ep",
        baseline_options_extra=DSV3_EP_OVERLAP_MOE_SEQ_OPTIONS
        + DSV3_EP_OVERLAP_EAGER,
        test_options_extra=DSV3_EP_OVERLAP_MOE_SEQ_OPTIONS + DSV3_EP_OVERLAP_GRAPH,
    )
...
def _run_deepseek_v3_ep_overlap_moe_batch_loss_compare() -> bool:
    ...
    return _run_deepseek_v3_loss_compare(
        ...
        + DSV3_EP_OVERLAP_EAGER,
        test_options_extra=DSV3_EP_OVERLAP_MOE_BATCH_OPTIONS + DSV3_EP_OVERLAP_GRAPH,
    )
