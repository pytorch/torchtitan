...
def _build_precompile_tests() -> list[PrecompileTestDefinition]:
    ...
    fx_trace_cp_precompile_dir = tempfile.mkdtemp(prefix="fx_trace_cp_precompile_")
    ...
    return [
        ...
        PrecompileTestDefinition(
            precompile_command=(
                ...
                " --config graph_trainer_llama3_debugmodel"
                " --compile.mode aot_fx_trace"
                f" --compile.precompile_artifact_dir {fx_trace_cp_precompile_dir}"
                " --parallelism.data_parallel_shard_degree 4"
            ...
            test_descr="aot_fx_trace llama3 precompile FSDP+CP",
            test_name="aot_fx_trace_llama3_precompile_fsdp_cp",
            ngpu=8,
        ),
        PrecompileTestDefinition(
            precompile_command=(
