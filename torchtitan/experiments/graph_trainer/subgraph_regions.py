...
def subgraph(
    ...
    *,
    ...
    ``preserve_order`` keeps the traced operation order inside the outlined
    region and allows nested higher-order operators.
    """
    if name is None:
        return nullcontext()
    ...
    *,
    ...
    for module in list(gm.modules()):
        ...
        for region, region_id, region_role, preserve_order, nodes in groups:
            ...
            if preserve_order:
                _strip_subgraph_arg_annotations(module, nodes, strip_custom_keys)
