...
from torchtitan.experiments.graph_based_training.common_utils import end_with_pass
...
def joint_graph_builder(
    ...
    if job_config is not None:
        ...
        if "inductor_decomposition" in pass_names:
            from torchtitan.experiments.graph_based_training.passes import (
