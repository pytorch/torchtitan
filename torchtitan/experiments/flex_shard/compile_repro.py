...
def _bucket_specs(depth: int, *, reshard_after_forward: bool) -> list[BucketSpec]:
...
def main() -> int:
    ...
    try:
        ...
        compiled_loss, compiled_grad_norm, compiled_trace_path = _run_maybe_profiled_step(
            compiled_model,
            x,
            args,
            rank,
