...
def main(job_config: JobConfig):
    ...
    if job_config.training.compile:
        # raise cache size limit to 4GB
        logger.info("Raising dynamo cache size limit to 4GB")
    ...
    # build dataloader
    tokenizer = train_spec.tokenizer_cls.from_pretrained(
    ...
    model_config = train_spec.config.from_pretrained(job_config.model.flavor)
    model_config.return_dict = False  # for compatibility with pipeline parallel
    # adapt util function
    model_config.n_layers = model_config.num_hidden_layers
    model_config.n_heads = model_config.num_attention_heads
    model_config.dim = model_config.hidden_size
    ...
    with (
        ...
        while train_state.step < job_config.training.steps:
            ...
            input_ids, labels, position_ids = batch
