...
```bash
python -m torchtitan.experiments.rl.train --module rl --config rl_grpo_qwen3_0_6b
```
...
Example:
```bash
python -m torchtitan.experiments.rl.train --module rl --config rl_grpo_qwen3_0_6b_batch_invariant
```
