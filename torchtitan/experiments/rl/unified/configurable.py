...
"""
Local copy of the Configurable base class.

This mirrors ``torchtitan.config.Configurable`` from the ``config`` branch.
Once that branch lands, replace all imports of this module with::
