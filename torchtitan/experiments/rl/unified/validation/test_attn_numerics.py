...
Run:
    torchrun --nproc_per_node=2 \
        torchtitan/experiments/rl/unified/validation/test_attn_numerics.py
"""
...
def build_trainer_model(config):
    ...
    hf_assets_path = config.trainer.hf_assets_path
    ...
    # Patch attention to use the same flash-attn kernel as vLLM
    replace_with_vllm_compatible_flash_attention(model, tp_size=parallel_dims.tp)
