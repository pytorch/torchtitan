...
def rl_dapo_deepseek_v3_16b_math_8k_perf() -> Controller.Config:
    """Run a random-weight DeepSeek-v3 16B DAPO systems benchmark on 8 GPUs.
    ...
    return Controller.Config(
        ...
        dump_folder="outputs/rl/deepseek_v3_16b_dapo_math_8k_perf",
        async_loop=AsyncLoopConfig(
            num_training_steps=150,
            num_prompts_per_train_step=8,
            num_samples_per_prompt=16,
        ...
        compile=CompileConfig(enable=True, backend="inductor"),
        rollouter=DapoMathRollouter.Config(
            token_env=TokenEnv.Config(
                max_rollout_tokens=max_total_tokens,
                max_num_turns=1,
