...
class ModelArgs:
    r"""
    This is the configuration class to store the configuration of a [`Qwen3MoE`]. It is used to instantiate an Qwen3MoE
    model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
    defaults will yield a similar configuration to that of the Qwen3MoE.
    ...
    Args:
        vocab_size (`int`, *optional*, defaults to 129280):
            ...
            `inputs_ids` passed when calling [`Qwen3MoE`]
