...
def build_compiler_toolkit_test_list() -> list[OverrideDefinitions]:
    ...
    integration_tests_flavors = [
        ...
        OverrideDefinitions(
            ...
            "compiler_toolkit llama3 FSDP+TP",
            "llama3_fsdp_tp",
            ngpu=8,
        ),
        OverrideDefinitions(
            ...
            "compiler_toolkit llama3 FSDP+TP+FlexAttn",
        ...
        OverrideDefinitions(
            ...
            "compiler_toolkit deepseek_v3 FSDP+TP+EP",
            "deepseek_v3_fsdp_tp_ep",
            ngpu=4,
        ),
        OverrideDefinitions(
            [
            ...
            "compiler_toolkit deepseek_v3 FSDP+TP+EP+FlexAttn",
            "deepseek_v3_fsdp_tp_ep_flexattn",
            ngpu=4,
        ),
    ]
