...
if __name__ == "__main__":
    """
    Copied from https://github.com/pytorch/torchtitan/blob/main/scripts/download_tokenizer.py.

    Usage:
        python download_tokenizer.py --repo_id <repo_id> --hf_token <hf_token> --local_dir <local_dir>

    Example:
        python download_tokenizer.py --repo_id meta-llama/Llama-3.2-1B --hf_token=...
