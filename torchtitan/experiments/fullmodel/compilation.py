...
"""
Unified JIT/AOT compilation dispatcher for fullmodel training.
...
from torchtitan.experiments.fullmodel.graph_utils import (
    CompiledModule,
...
from torchtitan.experiments.fullmodel.jit_backend import get_compile_backend_with_passes
...
def _apply_jit_compile(
    model: nn.Module,
    compile_config: FullmodelCompileConfig,
