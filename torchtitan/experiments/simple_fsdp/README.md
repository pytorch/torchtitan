...
```bash
CONFIG_FILE="./torchtitan/models/llama/train_configs/llama3_8b.toml"  bash run_train.sh --model.name llama3_simple_fsdp --training.compile --training.mixed_precision_param float32
```
