...
from .llama3.args import TransformerModelArgs
from .llama3.model import Transformer
from .llama3.state_dict_adapter import Llama3StateDictAdapter
...
llama3_args = {
    "debugmodel": TransformerModelArgs(
        dim=4096, n_layers=16, n_heads=16, vocab_size=2048, rope_theta=500000
    ),
...
def get_llama3_train_spec() -> TrainSpec:
    return TrainSpec(
