...
def example_usage():
    ...
    problem_sizes = [
        (4096, 4096, 128),  # Group 0: Small
        (8192, 2048, 256),  # Group 1: Medium
        (4096, 384, 192),  # Group 2: Different aspect ratio
    ]
    ...
    pytorch_time = benchmark.run_pytorch_mm(warmup=10, iterations=10)
