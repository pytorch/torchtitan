...
if [ "$TOTAL_GPUS" -ge 8 ]; then
    ...
    for test_args in \
        ...
        "FSDP + EP=4 + compile|--parallelism.data_parallel_shard_degree -1 --parallelism.expert_parallel_degree 4 compile:compile-config" \
        "FSDP + TP=2 + EP=2 + compile|--parallelism.data_parallel_shard_degree -1 --parallelism.tensor_parallel_degree 2 --parallelism.expert_parallel_degree 2 compile:compile-config" \
        "FSDP + TP=2 (MoE, no EP) + compile|--parallelism.data_parallel_shard_degree -1 --parallelism.tensor_parallel_degree 2 compile:compile-config" \
        ...
        "FSDP + PP=2 + EP=2 + compile|--parallelism.data_parallel_shard_degree -1 --parallelism.pipeline_parallel_degree 2 --parallelism.num_pp_microbatches 2 --parallelism.pipeline_parallel_schedule 1F1B --parallelism.expert_parallel_degree 2 compile:compile-config" \
...
if [ "${SKIP_MODEL_SWEEP:-0}" != "1" ]; then
    ...
    CONFIGS_4GPU=(
        ...
        "EP=4+compile|--parallelism.data_parallel_shard_degree -1 --parallelism.expert_parallel_degree 4 compile:compile-config"
        "TP=2+EP=2+compile|--parallelism.data_parallel_shard_degree -1 --parallelism.tensor_parallel_degree 2 --parallelism.expert_parallel_degree 2 compile:compile-config"
        "TP=2+compile|--parallelism.data_parallel_shard_degree -1 --parallelism.tensor_parallel_degree 2 compile:compile-config"
        ...
        "PP=2+EP=2+compile|--parallelism.data_parallel_shard_degree -1 --parallelism.pipeline_parallel_degree 2 --parallelism.num_pp_microbatches 2 --parallelism.pipeline_parallel_schedule 1F1B --parallelism.expert_parallel_degree 2 compile:compile-config"
