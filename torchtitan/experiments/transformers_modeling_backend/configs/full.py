...
MergedConfig = ConfigManager._merge_configs(Trainer.Config, TMBJobConfig)

# Start from defaults, then override
default_config = MergedConfig()

# [training]
default_config.job.description = "Qwen 3 full training"
...
# [model]
default_config.model_spec = model_registry("full")
...
default_config.dataloader.dataset = "c4"
