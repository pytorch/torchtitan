...
`MODEL=autoparallel.llama3 CONFIG=autoparallel_llama3_debugmodel ./run_train.sh --parallelism.tensor_parallel_degree 4`

**DeepSeekv3**

`NGPU=2 MODEL=autoparallel.deepseek_v3 CONFIG=autoparallel_deepseek_v3_debugmodel ./run_train.sh`
...
`NGPU=2 MODEL=autoparallel.local_map_deepseek_v3 CONFIG=autoparallel_local_map_deepseek_v3_debugmodel ./run_train.sh --parallelism.data_parallel_shard_degree 2 --parallelism.expert_parallel_degree 2`
