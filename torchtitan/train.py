...
class Trainer(torch.distributed.checkpoint.stateful.Stateful):
    ...
    def train_step(
        ...
        if len(lr_list) > 1:
            ...
            try:
                optimizer = self.optimizers.optimizers[0]  # CPU offload has single optimizer
    ...
    def train(self):
        ...
        # For CPU offload optimizer, sync GPU params to CPU after checkpoint load
        # (because optimizer was created before checkpoint loading)
