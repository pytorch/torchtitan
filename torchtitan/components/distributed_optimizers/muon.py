...
def _resolve_storage_to_compute_transition(
    ...
    ``Replicate`` accepts fully replicated storage. Replicated storage computes
    locally under every compatible declaration, including when a size-one mesh
    axis has normalized sharded storage to replication.
    """
