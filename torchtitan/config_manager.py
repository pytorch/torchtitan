...
class JobConfig:
    ...
    def __init__(self):
        ...
        self.parser.add_argument(
            "--training.offload_policy",
            type=bool,
            default=False,
            help="""
            The `offload_policy` argument specifies the offloading policy for FSDP, 
            whether to offload parameters to CPU when not involved in computation. 
