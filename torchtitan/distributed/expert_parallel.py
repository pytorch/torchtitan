...
class MXFP8ExpertParallel(ExpertParallel):
    def __init__(
        self,
        use_mxfp8_a2a_dispatch_fwd: bool = False,
        use_mxfp8_a2a_combine_bwd: bool = False,
    ):
        super().__init__()
        self.input_splits = None
        self.output_splits = None
        self.input_shape = None
        self.permuted_indices = None
        self.use_mxfp8_a2a_dispatch_fwd = use_mxfp8_a2a_dispatch_fwd
        self.use_mxfp8_a2a_combine_bwd = use_mxfp8_a2a_combine_bwd
        try:
