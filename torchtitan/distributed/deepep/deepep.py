...
# Import HybridEP (required for hybridep backend)
try:
    from deep_ep import HybridEPBuffer  # pyrefly: ignore [missing-import]
except ImportError as e:
    raise ImportError(
        "HybridEP is required for this module. "
        "Install from: https://github.com/deepseek-ai/DeepEP (checkout to hybrid_ep branch)"
    ) from e
...
_buffer: Buffer = None
_hybrid_ep_buffer: HybridEPBuffer = None
