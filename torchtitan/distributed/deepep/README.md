...
```toml
[deepep]
fused_silu_gate_prob = true  # Recommended for optimal throughput
```

### Available Kernels

| Config Option | Speedup | Description |
|--------------|---------|-------------|
| `fused_silu_gate_prob` | 3.2x | Fuses SiLU + gate + prob multiply |
| `fused_weighted_scatter_add` | 2-3x | Fuses weight multiply + scatter_add |
