...
This backend is intentionally narrow: it supports EP with optional TP, while CP
and PP are disabled. The symmetric-memory allocation is explicit and must happen
before dispatch.
