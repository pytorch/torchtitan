...
def extract_file(
    ...
    with tar.extractfile(member) as f:
        ...
        orig_size = img.size
        img = img.resize(resizing, resample=Image.Resampling.NEAREST).resize(
            orig_size, resample=Image.Resampling.NEAREST
        )
...
if __name__ == "__main__":
    ...
    Usage:
    python blur_generate_h5dataset_from_tarfile.py \
