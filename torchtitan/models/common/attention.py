...
class GQAttention(BaseAttention):
    ...
    inner_attention_remat_region = Module.register_remat_region("inner_attention")
    wo_remat_region = Module.register_remat_region("wo")
    ...
    def forward(
        ...
        out_THV = remat.region(
            ...
            self.remat_region_name(self.inner_attention_remat_region),
            recompute=self.remat_should_recompute(self.inner_attention_remat_region),
        )(
            xq_THK,
            xk_THK,
            xv_THV,
        ...
        out_TD = remat.region(
            self.wo,
            self.remat_region_name(self.wo_remat_region),
            recompute=self.remat_should_recompute(self.wo_remat_region),
        )(out_TD)
