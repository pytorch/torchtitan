...
"""Async tensor-parallel projection modules and their functional kernels."""
...
class AsyncColumnParallelLinear(ColumnParallelLinear):
    ...
    def forward(self, input: torch.Tensor) -> torch.Tensor:
        ...
        weight, bias = self.linear._flatten_weight_and_bias()
        ...
        return self.linear._unflatten_output(output)
