...
class Attention(nn.Module):
    ...
    # We registered flex_attention related attributeds as class variables as
    # we need to amortize the cost of compilation. Enabling per-instance
    # flex_attention is not supported yet.
