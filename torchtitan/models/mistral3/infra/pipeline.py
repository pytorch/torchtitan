...
from torch.distributed.pipelining.schedules import _PipelineSchedule, get_schedule_class
...
def pipeline_mistral3(
    ...
    stages, models = pipeline_llama_manual_split(
        model.language_model, pp_mesh, parallel_dims, job_config, device, model_config
    )
