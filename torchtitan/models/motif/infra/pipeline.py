...
from torchtitan.distributed.pipeline_stage_ext import PipelineStageExt
...
def pipeline_motif(
    ...
    stages, model_parts = pipeline_motif_manual_split(
...
def pipeline_motif_manual_split(
    ...
    device: DeviceType,
    model_config: TransformerModelArgs,
) -> tuple[list[PipelineStageExt], list[nn.Module]]:
    """
    ...
    def _build_stage(
        ...
        is_first: bool = False,
        is_last: bool = False,
    ) -> tuple[PipelineStageExt, nn.Module]:
