...
llama3_args = {
    ...
    "debugmodel_flex_attn": TransformerModelArgs(
        dim=256,
        n_layers=6,
        n_heads=2,  # head_dim=128, same as debugmodel_flex_flash for comparison
        vocab_size=2048,
        rope_theta=500000,
        attn_type="flex",
    ...
    "debugmodel_flex_flash": TransformerModelArgs(
        ...
        flex_attention_block_size=(128, 128),
    ),
    ...
    "8B_flex_flash": TransformerModelArgs(
        dim=4096,
        n_layers=32,
        n_heads=32,
        n_kv_heads=8,
    ...
    "70B_flex_flash": TransformerModelArgs(
        dim=8192,
        n_layers=80,
        n_heads=64,
        n_kv_heads=8,
    ...
    "70B_flex_triton": TransformerModelArgs(
        dim=8192,
        n_layers=80,
        n_heads=64,
        n_kv_heads=8,
        ...
        attn_type="flex",
        attn_mask_type="block_causal",
        flex_attention_kernel_options={"BACKEND": "TRITON"},
        flex_attention_block_size=(128, 128),
    ),
