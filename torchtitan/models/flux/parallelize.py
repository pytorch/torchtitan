...
def parallelize_flux(
    ...
    *,
    ...
    if parallel_dims.cp_enabled:
        apply_cp(model, parallel_dims.get_mesh("cp"), tensor_mesh=parallel_dims.get_optional_mesh("tp"))
...
def apply_cp(model: nn.Module, cp_mesh: DeviceMesh, tensor_mesh: DeviceMesh | None = None) -> None:
    """
    ...
    apply_cp_to_attention_module(attention_modules, cp_mesh, "sdpa", tensor_mesh=tensor_mesh)
