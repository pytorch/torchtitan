...
MergedJobConfig = ConfigManager._merge_configs(JobConfig, FluxJobConfig)

# Start from defaults, then override
default_config = MergedJobConfig()

# [job]
default_config.job.description = "Flux-dev model"
...
default_config.model.flavor = "flux-dev"
...
default_config.encoder.max_t5_encoding_len = 512
...
default_config.validation.local_batch_size = 32
default_config.validation.steps = 12
