...
# training techniques (e.g. activation checkpointing and compile) to the Olmo3 model.
...
from torchtitan.models.olmo3.model import Olmo3Model


def parallelize_olmo3(
    model: Olmo3Model,
    *,
    ...
    """
    Apply activation checkpointing, torch.compile, and FSDP to the model.
