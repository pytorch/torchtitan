            ...
            layer_plan.update(
                {
                    ...
                    # q_norm/k_norm receive Shard(2) input (heads dim sharded
                    # by ColwiseParallel on wq/wk). Preserve the shard so
                    # downstream attention sees the correct per-rank head count.
                    "attention.q_norm": NoParallel(output_layout=Shard(2)),
                    "attention.k_norm": NoParallel(output_layout=Shard(2)),
