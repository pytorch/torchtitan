...
def parallelize_qwen3(
    ...
    if parallel_dims.tp_enabled:
        ...
        # this activated may not work, see deepseekv3
    ...
    if parallel_dims.fsdp_enabled or parallel_dims.ep_enabled: # dp_shard, or dp_shard_cp, or ep_enabled
        ...
        if tp_mesh is not None:
            ...
            if transformer_block.moe.shared_experts is not None:
                ...
                moe_layer_plan.update(
                    {
                        "mlp.shared_experts.w1": ColwiseParallel(),
                        "mlp.shared_experts.w2": RowwiseParallel(
                            output_layouts=Partial()
                        ),
                        "mlp.shared_experts.w3": ColwiseParallel(),
                    }
                )
            parallelize_module(
    ...
    for layer_id, transformer_block in model.layers.items():
        ...
        if transformer_block.moe_enabled and ep_degree > 1:
            ...
            if (
                ...
                > transformer_block.mlp.experts.num_experts
            ):
