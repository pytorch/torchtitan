...
from .attention import MLAFlexInnerAttention, MLAVarlenInnerAttention
...
def _ulysses_cp_mla_forward(
    ...
    **kwargs,
    ...
    out_THV = inner_forward(q_THK, kv_THP, k_shared_TR, **kwargs)
...
class KVAllGatherCPMLAFlexInnerAttention(CPInnerAttention, MLAFlexInnerAttention):
...
class UlyssesCPMLAFlexInnerAttention(CPInnerAttention, MLAFlexInnerAttention):
...
class UlyssesCPMLAVarlenInnerAttention(
    CPInnerAttention, MLAVarlenInnerAttention
):
