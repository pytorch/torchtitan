...
The 16B and 671B training configs use FlexAttention's FlashAttention 4 backend.
Install a compatible `flash-attn-4` build before running them, for example
`pip install --pre "flash-attn-4[cu13]"` for CUDA 13.
