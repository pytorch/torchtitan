...
from torchtitan.models.common import FeedForward, RoPE, trunc_normal_
    ...
    class Config(BaseModel.Config):
        ...
        def update_from_config(
            ...
            **kwargs,
            ...
            # Sync rope fields to attn_config
            self.attn_config = _dc.replace(
                self.attn_config,
                rope_max_seq_len=seq_len,
                rope_factor=self.rope_config.rope_factor,
                rope_original_seq_len=self.rope_config.original_seq_len,
            )
            ...
            if (
                ...
                and self.attn_config.attn_backend != "sdpa"
            ):
            ...
            if parallelism.expert_parallel_comm_backend == "deepep":
                ...
                self.moe_config = _dc.replace(
                    DeepEPMoE.Config(**_dc.asdict(self.moe_config))
                )
        ...
        def get_nparams_and_flops(
            ...
            return get_moe_model_nparams_and_flops(
                ...
                self.attn_config.qk_nope_head_dim
                + self.attn_config.qk_rope_head_dim
