...
from torchtitan.models.parallelize import (
    apply_compile,
    apply_fsdp,
    apply_moe_ep_tp,
)
...
_op_sac_save_list = {
    ...
    torch._higher_order_ops.flex_attention,  # type: ignore
    torch._higher_order_ops.inductor_compiled_code,  # type: ignore
}
...
def parallelize_deepseekv3(
    ...
    if job_config.parallelism.expert_parallel_comm_backend == "deepep":
        ...
        import torchtitan.distributed.deepep  # noqa: F401 - registers torch.ops.deepep  # type: ignore
...
def apply_non_moe_tp(
    ...
    for transformer_block in model.layers.values():  # type: ignore
        ...
        if transformer_block.attention.q_lora_rank == 0:  # type: ignore
            layer_plan.update(
                {
