...
deepseekv3_args = {
    ...
    "debugmodel_1b": DeepSeekV3ModelArgs(
        vocab_size=2048,
        dim=1024,
        inter_dim=4096,
        moe_inter_dim=1024,
    ...
    "debugmodel_7b": DeepSeekV3ModelArgs(
        vocab_size=2048,
        dim=2048,
        inter_dim=8192,
        moe_inter_dim=2048,
    ...
    # kimi_k2 with SDPA (no FlexAttention) for Context Parallel compatibility
    "kimi_k2_sdpa": DeepSeekV3ModelArgs(
        vocab_size=163840,
        dim=7168,
        inter_dim=18432,
        moe_inter_dim=2048,
        ...
        qk_rope_head_dim=64,
        v_head_dim=128,
        use_flex_attn=False,  # Use SDPA for CP compatibility
