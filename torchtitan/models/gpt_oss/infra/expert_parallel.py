...
class GptossTensorParallel(TensorParallel):
    def _partition_fn(self, name, module, device_mesh):
        ...
        # Invalidate caches after parallelization (weights changed from Tensor to DTensor)
        module._cached_tp_degree = None
        module._is_dtensor = None
...
class GptossExpertTensorParallel(ExpertTensorParallel):
    def _partition_fn(self, name: str, mod: nn.Module, device_mesh: DeviceMesh) -> None:
        ...
        # Invalidate caches after parallelization (weights changed from Tensor to DTensor)
        mod._cached_tp_degree = None
        mod._is_dtensor = None
