...
from torchtitan.protocols.sharding import RedistributionSpec
...
class SymmMemTPAllReduce(RedistributionSpec):
    @dataclass(kw_only=True, slots=True)
    class Config(RedistributionSpec.Config):
        pass
...
def _is_tp_all_reduce(cfg: RedistributionSpec.Config) -> bool:
    return (
...
@override(
    ...
    target=RedistributionSpec.Config,
