...
def parallelize_llama(
    ...
    if parallel_dims.ep_mode != "none":
        if parallel_dims.ep_mode == "dp2ep":
            print("Applying dp2ep")
            print(f"ep_mesh: {world_mesh['ep']}")
            # assert False, "check EP"
        apply_ep(
            model,
...
def apply_ep(
    ...
    if ep_mode == "tp":
        ...
        print(f"Applying {ep_mode} to the model")
        ...
        if not tp_mesh:
            ...
            print(f"Applying {ep_mode} to the model, {ep_mesh=}")
            # assert False, "check EP"
