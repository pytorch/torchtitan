...
It lives under ``torchtitan/rl`` rather than ``torchtitan/models/muse_glimmer`` because
...
from torchtitan.rl.renderer import RendererConfig, RendererTokenizerWrapper
